...
namespace One.AutoUpdater.Interfaces
{
    /// <summary> Provides a mechanism for storing AutoUpdater state between sessions. 提供在会话之间存储自动更新程序状态的机制。 </summary>
    public interface IPersistenceProvider
    {
        /// <summary> Reads the flag indicating whether a specific version should be skipped or not. </summary>
        ...
        /// <summary> Reads the value containing the date and time at which the user must be given again the possibility to upgrade the application. </summary>
        ...
        /// <summary> Sets the values indicating the specific version that must be ignored by AutoUpdater. </summary>
        ...
        /// <summary> Sets the date and time at which the user must be given again the possibility to upgrade the application. </summary>

namespace One.Control.Controls.Dragablz
{
    ...
    {
        /// <summary> The header size collapses to zero along the correct axis. </summary>
        Collapse,

        /// <summary> The header size remains that of the last tab prior to the tab header becoming empty. </summary>
        PreviousTab,

        //TODO implement EmptyHeaderSizingHint.Stretch
        /// <summary> The header stretches along the according axis. </summary>
        //Stretch
    }
}
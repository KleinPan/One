...
{
    /// <summary> Implementors should provide a mechanism to provide a new host control which contains a new <see cref="TabablzControl"/>. </summary>
    public interface IInterLayoutClient
    {
        /// <summary> Provide a new host control and tab into which will be placed into a newly created layout branch. </summary>

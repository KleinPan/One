...
{
    /// <summary> Implementors should provide mechanisms for providing new windows and closing old windows. </summary>
    public interface IInterTabClient
    {
        /// <summary> Provide a new host window so a tab can be teared from an existing window into a new window. </summary>
        ...
        /// <summary> Called when a tab has been emptied, and thus typically a window needs closing. </summary>

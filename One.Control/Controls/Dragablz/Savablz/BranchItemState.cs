...
{
    /// <summary> The item that is stored in a branch state (first or second) </summary>
    /// <typeparam name="TTabItem"> The tab item type </typeparam>
    public class BranchItemState<TTabItem>
    {
        /// <summary> The generic constructor, used by the Json deserializer </summary>
        ...
        /// <summary> The branch, if this item is a branch, <c> null </c> otherwise </summary>
        public BranchState<TTabItem> ItemAsBranch { get; }

        /// <summary> The tab set, if this item is a tab set, <c> null </c> otherwise </summary>

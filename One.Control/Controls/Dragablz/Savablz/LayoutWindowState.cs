...
namespace One.Control.Controls.Dragablz.Savablz
{
    ...
    public class LayoutWindowState<TTabModel>
    {
        ...
        /// <summary> The window's X position </summary>
        public double X { get; }

        /// <summary> The window's Y position </summary>
        public double Y { get; }
        ...
        /// <summary> The window state (maximized, restored, minimize) </summary>
        public WindowState WindowState { get; }

        /// <summary> The root of this layout </summary>

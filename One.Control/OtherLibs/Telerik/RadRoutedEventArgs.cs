...
namespace One.Control.OtherLibs.Telerik
{
    ...
    {
        /// <summary> Initializes a new instance of the RadRoutedEventArgs class. </summary>
        public RadRoutedEventArgs()
        {
        }

        /// <summary> Initializes a new instance of the RadRoutedEventArgs class, using the supplied routed event identifier. </summary>
        ...
        /// <summary> Initializes a new instance of the RadRoutedEventArgs class, using the supplied routed event identifier, and providing the opportunity to declare a different source for the event. </summary>
        /// <param name="routedEvent"> The routed event identifier for this instance of the RoutedEventArgs class. </param>

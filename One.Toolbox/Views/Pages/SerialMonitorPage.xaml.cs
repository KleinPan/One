...
{
    /// <summary> SerialMonitorPage.xaml 的交互逻辑 </summary>
    public partial class SerialMonitorPage : Page
    {
        ...
        private CallbackDelegate myDelegate = new CallbackDelegate((e) =>
        {
            ...
            //Tools.Logger.ShowDataRaw(new DataShowRaw
            //{
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            if (first)
            {
                ...
                catch
                {
                    ...
                    Tools.MessageBox.Show("插件加载失败，目前该功能还不兼容x64版本的One.Toolbox。\r\n" +
